...
tic
%**************读取网络节点间的cost*************************
nsfnet_cost=load('nsfnet_cost.txt');%读取nsfnet的cost值
...
[topology,cost]=Generate_CostMatrix(nsfnet_cost);
...
Fitness_upper=Fitness_upper_Calc(Pop_DCplacement,Pop_Routing,Traffic,K_Path_Traffic,Total_Vnf,nsfnet_cost,Weight_upper);
...
for upper_gen=1:Gen_max
    for lower_gen=1:Gen_max
         lower_gen 
      Temp_Fitness_upper1=Fitness_upper_Calc(Pop_DCplacement,Pop_Routing,Traffic,K_Path_Traffic,Total_Vnf,nsfnet_cost,Weight_upper);
       for i=1:Pop_size
...
[bestValue_upper bestPop_upper bestPop_DC_upper bestPop_Rout_upper]=min_value(Fitness_upper,Pop_DCplacement,Pop_Routing);         
 ...
 [bestPop_DC_lower bestPop_Rout_lower]=unique_struct(bestPop_DC_lower,bestPop_Rout_lower);
     Fitness_upper=Fitness_upper_Calc(bestPop_DC_lower, bestPop_Rout_lower,Traffic,K_Path_Traffic,Total_Vnf,nsfnet_cost,Weight_upper);
