function Fitness_upper=Fitness_upper_Calc(Pop_DCplacement, Pop_Routing,Traffic,K_Path_Traffic,Total_Vnf,usbackbone_cost,Weight_upper)
...
for pop_dc=1:size(Pop_DCplacement,2)
     ...
     for pop_rout=1:size(pop_routing,2)
          ...
          temp_fitness_upper=temp_fitness_upper_calc_new1(temp_pop_dc,temp_pop_rout,Traffic,path_traffic,Total_Vnf,usbackbone_cost,Weight_upper);
