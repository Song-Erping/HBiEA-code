function temp_fitness_upper1=temp_fitness_upper_calc_new1(temp_pop_dc,temp_pop_rout,Traffic,Path_Traffic,Total_Vnf,usbackbone_cost,Weight_upper)
global Num_VNF;
...
nsfnet_cost_dc=usbackbone_cost(index,index);
a1=size(nsfnet_cost_dc);
num_node=length(temp_pop_dc);
a2=size(usbackbone_cost);
[i,j,v]=find(usbackbone_cost);
